...
class AKFKDebugEndpoint(AKFBaseEndpoint):
    SHORT = "kdebug"
    ...
    def GetBuf(self, msg):
        ...
        self.iobuffer0, self.iobuffer0_iova = self.akf.ioalloc(size)
        self.send(KDebugSendBufMessage(TYPE=1, DVA=self.iobuffer0_iova))

        self.iobuffer1, self.iobuffer1_iova = self.akf.ioalloc(0x2000)
