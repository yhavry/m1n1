...
from .crash import AKFCrashLogEndpoint
from .syslog import AKFSysLogEndpoint
from .mgmt import AKFManagementEndpoint
from .kdebug import AKFKDebugEndpoint
from .ioreporting import AKFIOReportingEndpoint
from .base import AKFBaseEndpoint, AKFTimeout
from ...hw.akf import AKF

__all__ = []

class AKFDummyEndpoint(AKFBaseEndpoint):
    SHORT = "dummy"

class StandardAKF(AKF):
    ENDPOINTS = {
        0: AKFManagementEndpoint,
        1: AKFCrashLogEndpoint,
        2: AKFSysLogEndpoint,
        3: AKFKDebugEndpoint,
        4: AKFIOReportingEndpoint,
        5: AKFDummyEndpoint,
    }

    def __init__(self, u, adt_path, dart=None, stream=0):
        super().__init__(u, adt_path)
        self.remote_eps = set()
        self.iface = u.iface
        self.add_ep(0, AKFManagementEndpoint(self, 0))
        self.dart = dart
        self.stream = stream
        self.eps = []
        self.epcls = {}
